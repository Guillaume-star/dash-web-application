...
def make_graph(state):
    ...
    df = new_df2[['Year', 'Number of dependents', 'Number of exemptions',
                  'Number of \r\nfarm returns', 'Child tax credit Number of returns',
                  'Number of joint returns']]

    fig2 = px.line(df, x='Year', y=df.columns[2], markers=True, title='Number of Exemptions',
                   labels={'Year': '', 'Number of exemptions': ''})
    ...
    fig3 = px.line(df, x='Year', y=df.columns[3], markers=True, title='Number of farm returns',
                   labels={'Year': '', 'Number of \r\nfarm returns': ''})
    ...
    fig4 = px.line(df, x='Year', y=df.columns[4], markers=True, title='Child tax credit-Number of returns',
                   labels={'Year': '', 'Child tax credit Number of returns': ''})
